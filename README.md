# Memcached service for Kubernetes on Wodby

Run Memcached as a data store for Kubernetes applications managed by Wodby.
...
- [Memcached application stack](https://github.com/wodby/stack-memcached)
...
| Type | Data store |
| Versions | `1.6` by default |
| Workloads | `main` (Deployment, primary) |
| Containers | `memcached` using `wodby/memcached` |
...
Use this service through [Memcached application stack](https://github.com/wodby/stack-memcached), or reference `memcached` from a
custom Wodby stack.
